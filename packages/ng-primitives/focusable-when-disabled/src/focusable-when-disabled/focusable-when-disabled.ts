...
} from './focusable-when-disabled-state';

@Directive({
  selector: '[ngpFocusableWhenDisabled]',
  exportAs: 'ngpFocusableWhenDisabled',
  providers: [provideFocusableWhenDisabledState({ inherit: false })],
})
export class NgpFocusableWhenDisabled {
  /**
   ...
   * The button state.
   */
  protected readonly state = ngpFocusableWhenDisabled({
